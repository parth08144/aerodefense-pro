...
function seed() {
    ...
    const products = [
        ...
        { name:'F-35A Lightning II', slug:'f-35a-lightning-ii', cat:'fighter-jet', mfr:'Lockheed Martin', origin:'USA', desc:'The most advanced multi-role stealth fighter, combining sensor fusion and network-centric warfare.', price:80000000, status:'available', gen:'5th Gen', cls:'Multirole', img:'/images/jets/f35.jpg', featured:1, stock:5,
          specs:[
        ...
        { name:'Su-57 Felon', slug:'su-57-felon', cat:'fighter-jet', mfr:'Sukhoi', origin:'Russia', desc:'Russia\'s 5th-generation stealth fighter with extreme maneuverability and advanced sensor suite.', price:42000000, status:'available', gen:'5th Gen', cls:'Air Superiority', img:'/images/jets/su57.jpg', featured:1, stock:2,
          specs:[
        ...
        { name:'Dassault Rafale', slug:'dassault-rafale', cat:'fighter-jet', mfr:'Dassault Aviation', origin:'France', desc:'France\'s omnirole fighter — carrier-capable, nuclear-capable, battle-proven across global theaters.', price:100000000, status:'available', gen:'4.5 Gen', cls:'Omnirole', img:'/images/jets/rafale.jpg', featured:0, stock:3,
          specs:[
        ...
        { name:'F-15EX Eagle II', slug:'f-15ex-eagle-ii', cat:'fighter-jet', mfr:'Boeing', origin:'USA', desc:'The most advanced Eagle ever built — massive payload, digital backbone, and unmatched combat record.', price:88000000, status:'available', gen:'4.5 Gen', cls:'Multirole', img:'/images/jets/f15ex.jpg', featured:0, stock:4,
          specs:[
        ...
        { name:'Saab Gripen E', slug:'saab-gripen-e', cat:'fighter-jet', mfr:'Saab', origin:'Sweden', desc:'Cost-effective next-gen fighter with network-centric warfare and short-field operations capability.', price:85000000, status:'available', gen:'4.5 Gen', cls:'Multirole', img:'/images/jets/gripen.jpg', featured:0, stock:6,
          specs:[
        ...
        { name:'Su-35 Flanker-E', slug:'su-35-flanker-e', cat:'fighter-jet', mfr:'Sukhoi', origin:'Russia', desc:'Ultimate Flanker variant with thrust-vectoring supermaneuverability and Irbis-E long-range radar.', price:65000000, status:'available', gen:'4++ Gen', cls:'Air Superiority', img:'/images/jets/su35.jpg', featured:0, stock:3,
          specs:[
        ...
        { name:'HAL Tejas Mk2', slug:'hal-tejas-mk2', cat:'fighter-jet', mfr:'HAL', origin:'India', desc:'India\'s indigenous light combat aircraft with advanced avionics and modern weapons integration.', price:42000000, status:'pre-order', gen:'4.5 Gen', cls:'Light Combat', img:'/images/jets/tejas.jpg', featured:0, stock:8,
          specs:[
        ...
        // MISSILES
        { name:'AIM-120D AMRAAM', slug:'aim-120d-amraam', cat:'missile', mfr:'Raytheon', origin:'USA', desc:'Beyond-visual-range air-to-air missile with active radar homing and two-way datalink.', price:1800000, status:'available', gen:null, cls:'Air-to-Air / BVR', img:'/images/missiles/aim120.jpg', featured:1, stock:50,
          specs:[
        ...
        { name:'BrahMos-II', slug:'brahmos-ii', cat:'missile', mfr:'BrahMos Aerospace', origin:'India/Russia', desc:'Hypersonic cruise missile capable of Mach 7+ speeds, virtually impossible to intercept.', price:2730000, status:'pre-order', gen:null, cls:'Cruise / Hypersonic', img:'/images/missiles/brahmos.jpg', featured:1, stock:20,
          specs:[
        ...
        { name:'BGM-109 Tomahawk', slug:'bgm-109-tomahawk', cat:'missile', mfr:'Raytheon', origin:'USA', desc:'Long-range, all-weather cruise missile — the backbone of U.S. precision strike for three decades.', price:1870000, status:'available', gen:null, cls:'Cruise / Land Attack', img:'/images/missiles/tomahawk.jpg', featured:0, stock:40,
          specs:[
        ...
        { name:'Meteor BVRAAM', slug:'meteor-bvraam', cat:'missile', mfr:'MBDA', origin:'Europe', desc:'Ramjet-powered BVR missile with no-escape zone larger than any competitor. Game-changer in air combat.', price:2500000, status:'available', gen:null, cls:'Air-to-Air / BVR', img:'/images/missiles/meteor.jpg', featured:0, stock:35,
          specs:[
        ...
        { name:'IRIS-T SLM', slug:'iris-t-slm', cat:'missile', mfr:'Diehl Defence', origin:'Germany', desc:'Medium-range surface-to-air missile with advanced IR imaging seeker and 360° engagement.', price:430000, status:'available', gen:null, cls:'Surface-to-Air', img:'/images/missiles/irist.jpg', featured:0, stock:60,
          specs:[
        ...
        { name:'AIM-9X Sidewinder', slug:'aim-9x-sidewinder', cat:'missile', mfr:'Raytheon', origin:'USA', desc:'Short-range IR air-to-air missile with thrust vectoring, helmet-cued off-boresight engagement.', price:600000, status:'available', gen:null, cls:'Air-to-Air / WVR', img:'/images/missiles/aim9x.jpg', featured:0, stock:80,
          specs:[
        ...
        { name:'AGM-88G AARGM-ER', slug:'agm-88g-aargm-er', cat:'missile', mfr:'Northrop Grumman', origin:'USA', desc:'Extended-range anti-radiation missile to destroy enemy air defense radar systems.', price:1200000, status:'available', gen:null, cls:'Anti-Radiation', img:'/images/missiles/aargm.jpg', featured:0, stock:30,
          specs:[
        ...
        { name:'Aegis Combat System', slug:'aegis-combat-system', cat:'defense-system', mfr:'Lockheed Martin', origin:'USA', desc:'Integrated naval weapons system — the most capable ship-based defense platform ever deployed.', price:1200000000, status:'pre-order', gen:null, cls:'Naval Integrated Defense', img:'/images/defense/aegis.jpg', featured:0, stock:1,
          specs:[
        ...
        { name:'Phalanx CIWS', slug:'phalanx-ciws', cat:'defense-system', mfr:'Raytheon', origin:'USA', desc:'Autonomous close-in weapon system — last line of defense against anti-ship missiles and aircraft.', price:5600000, status:'available', gen:null, cls:'Close-In Weapon System', img:'/images/defense/phalanx.jpg', featured:0, stock:5,
          specs:[
